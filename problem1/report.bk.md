...
| 指标 | 数值 |
| --- | --- |
| R² | 0.9891269169220263 |
| Adjusted R² | 0.9890181860912465 |
| RMSE | 1.7434118861399621 |
| MAE | 1.5086577050876548 |
| MSE (噪声方差估计) | 3.0394850047341 |
| 偏置 b | 151.6440306713597 |
| 权重均值 | 5.102415759861522 |
| 权重标准差 | 2.825254316167777 |
| 权重最小值 | 0.12845687578427434 |
| 权重最大值 | 9.766091970473099 |
...
![Figure 1: Weight Distribution](..\outputs\problem1\weights_bar.png)

## Figure 2: Residual Histogram

![Figure 2: Residual Histogram](..\outputs\problem1\residual_hist.png)

## Figure 3: Residual vs Fitted

![Figure 3: Residual vs Fitted](..\outputs\problem1\residual_fitted.png)
